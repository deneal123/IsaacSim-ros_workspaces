...
def generate_launch_description():
    ...
    launch_args = [
        ...
        DeclareLaunchArgument(
            'use_static_tf',
            default_value='False',
            description='Publish static map->world TF when True'),
    ...
    rviz_config_dir = os.path.join(
        get_package_share_directory('isaac_ros_vda5050_client_bringup'),
    ...
    # Static transform publisher: map -> world (optional)
    map_to_world_publisher = Node(
        package='tf2_ros',
    ...
    # Static transform publisher: map -> odom (optional)
